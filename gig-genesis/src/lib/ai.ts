...
const SKILL_MAP: Record<string, string[]> = {
  canva: ["canva-menu", "thumbnails", "deck", "logo"],
  design: ["deck", "logo", "canva-menu", "thumbnails"],
  figma: ["deck", "logo", "thumbnails"],
  reels: ["ig-reels", "ugc", "video-edit"],
  "video editing": ["video-edit", "ig-reels", "thumbnails"],
  ...
  javascript: ["js-automation", "tutor"],
  typescript: ["js-automation", "tutor"],
  node: ["js-automation", "tutor"],
  react: ["js-automation", "tutor"],
  coding: ["py-script", "js-automation", "java-api", "tutor"],
  teaching: ["tutor"],
  english: ["tutor", "blog"],
